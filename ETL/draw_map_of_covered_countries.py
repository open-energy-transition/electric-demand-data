...
Description:
    ...
    This script generates a map of the countries and subdivisions with
    available data. The shapes of standard countries and subdivisions
    are taken from the Natural Earth database. The shapes of
    non-standard countries and subdivisions are taken from the shapes
    generated by the respective scripts.
"""
...
for code in codes:
    ...
    # Define the transparency of the shape based on the number of years
    # of available data.
